...
export class HiFiControls {
    constructor({ mainAppElement }) {
        ...
        mainAppElement.addEventListener("gesturestart", (e) => { e.preventDefault(); }, false);
        mainAppElement.addEventListener("gesturechange", (e) => { e.preventDefault(); }, false);
        mainAppElement.addEventListener("gestureend", (e) => { e.preventDefault(); }, false);
        mainAppElement.addEventListener("contextmenu", (e) => { e.preventDefault(); }, false);
        this.onCanvasDown = (e) => { };
        this.onCanvasMove = (e, base, delta) => { };
        this.onLeftDrag = (e, base, delta) => { };
        this.onRightDrag = (e, base, delta) => { };
        this.onPinch = (e, base, delta) => { };
        this.onRotate = (e, base, delta) => { };
        this.onClick = (e) => { };
        this.onWheel = (e) => { };
        this._keyboardEventCache = [];
        mainAppElement.addEventListener('keydown', (e) => { this._onUserKeyDown(e); }, false);
        mainAppElement.addEventListener('keyup', (e) => { this._onUserKeyUp(e); }, false);
    ...
    _getEventFromCacheByID(idToFind) {
        for (let i = 0; i < this._mouseEventCache.length; i++) {
    ...
    _handleGestureOnCanvasStart(event) {
    ...
    _handleGestureOnCanvasMove(event) {
        event.preventDefault();
        let gesturePoint = this._getGesturePointFromEvent(event);
    ...
    _handleGestureOnCanvasEnd(event) {
        event.preventDefault();
        if (event.pointerId) {
    ...
    _handleGestureOnCanvasCancel(event) {
        this._handleGestureOnCanvasEnd(event);
    }
...
//# sourceMappingURL=HiFiControls.js.map
...
async function startDJBot(audioPath, position, hiFiGain) {
    let position2 = { x: argv.x * -1, y: argv.y, z: argv.z };
    let position3 = { x: argv.x, y: argv.y, z: argv.z * -1 };
    let position4 = { x: argv.x * -1, y: argv.y, z: argv.z * -1 };
...
​
    ...
    const audioBuffer = await decode(audioFile),
        ...
        hifiCommunicator2 = new HiFiCommunicator({ initialHiFiAudioAPIData2 }),
        hifiCommunicator3 = new HiFiCommunicator({ initialHiFiAudioAPIData3 }),
        hifiCommunicator4 = new HiFiCommunicator({ initialHiFiAudioAPIData4 });        
​
    ...
    await hifiCommunicator2.setInputAudioMediaStream(inputAudioMediaStream);
    await hifiCommunicator3.setInputAudioMediaStream(inputAudioMediaStream);
    await hifiCommunicator4.setInputAudioMediaStream(inputAudioMediaStream);
​
...
​
    ...
    console.log(hifiCommunicator);
    console.log(hifiCommunicator2);
    console.log(hifiCommunicator3);
    console.log(hifiCommunicator4);
}
​
